...
// September 10 Grant Portal launch feature, kept separate from the September 4 episode story.
export const GRANT_PORTAL_FEATURED_LAUNCH: FeaturedCoverage = {
  "presentation": "launch",
  ...
  "sourceLabel": "Grant Portal",
  "sourceUrl": "https://www.innovatinghighered.com/innovation-grants",
  "sources": [
    {
      "label": "Grant Portal",
      "url": "https://www.innovatinghighered.com/innovation-grants"
    },
    {
      "label": "About the founders",
      "url": "https://www.innovatinghighered.com/about"
    }
  ],
  "reportTitle": "Grant Portal launch",
  "category": "Feature Launch",
  "imagePath": "/images/feature-coverage/grant-portal-no-url.png",
  "imageWidth": 1672,
  "imageHeight": 941,
  "imageAlt": "Illustration for Innovating Higher Ed’s Grant Portal: a person walks through a glowing gateway toward a stylized portal interface with filters for institution, area, and deadline, plus Teaching & Learning, Student Success, and Research categories. Text reads “Need Funding? Indeed, there’s a portal for that.” and “Your Innovation. Our grant portal.”",
  "sections": [
    {
      "paragraphs": [
