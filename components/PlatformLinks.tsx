...
export type PlatformName = 'x' | 'instagram' | 'youtube' | 'apple' | 'spotify' | 'audible';
...
export const PLATFORM_LINKS: ReadonlyArray<PlatformLink> = [
  {
    name: 'x',
    label: 'X.com',
    href: 'https://x.com/InnovatingEd',
    accessibleLabel: 'Follow Innovating Higher Ed on X.com',
  },
  {
    name: 'instagram',
    label: 'Instagram',
    href: 'https://www.instagram.com/innovatinghighered/',
    accessibleLabel: 'Follow Innovating Higher Ed on Instagram',
  },
  {
    name: 'youtube',
    label: 'YouTube',
    href: 'https://www.youtube.com/@InnovatingHigherEd',
    accessibleLabel: 'Subscribe to Innovating Higher Ed on YouTube',
  },
  {
    name: 'apple',
    label: 'Apple Podcasts',
    href: 'https://podcasts.apple.com/us/podcast/innovating-higher-ed/id1774879335',
    accessibleLabel: 'Listen to Innovation Pulse on Apple Podcasts',
  },
  {
    name: 'spotify',
    label: 'Spotify',
    href: 'https://open.spotify.com/show/4rMDJnlFbrLMr0hKAE3Oe6',
    accessibleLabel: 'Listen to Innovation Pulse on Spotify',
  },
  {
    name: 'audible',
    label: 'Audible',
    href: 'https://music.amazon.com/podcasts/3ab228ea-6a9d-4173-95e9-dcc03bc6ecc9/innovating-higher-ed',
    accessibleLabel: 'Listen to Innovation Pulse on Audible via Amazon Music',
  },
];

const ICON_PATHS: Record<PlatformName, ReactNode> = {
      ...
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <defs>
          <linearGradient id={instagramGradientId} x1="2" y1="22" x2="22" y2="2" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="0.52" stopColor="#fd1d1d" />
            <stop offset="1" stopColor="#fcb045" />
          </linearGradient>
        </defs>
        <g fill={`url(#${instagramGradientId})`}>{ICON_PATHS.instagram}</g>
      </svg>
    );
  }
