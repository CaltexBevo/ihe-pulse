...
export const metadata: Metadata = pageMetadata({ title: "Browse All Stories | Innovating Higher Ed", description: "Explore ideas, research, and practical examples for higher education.", path: "/innovation-pulse/stories" });
...
export default function AllStoriesPage() {
 ...
 return <AllStoriesClient stories={stories} />;
}
