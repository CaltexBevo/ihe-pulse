...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon-32.png?v=20260916", sizes: "32x32", type: "image/png" },
      { url: "/icon-512.png?v=20260916", sizes: "512x512", type: "image/png" },
    ],
    apple: "/apple-touch-icon.png?v=20260916",
  },
  openGraph: {
    ...
    images: [
      {
        url: "https://www.innovatinghighered.com/og-image-white-tile-v4.png",
        width: 1254,
        height: 1254,
  ...
  twitter: {
    card: "summary",
    images: ["https://www.innovatinghighered.com/og-image-white-tile-v4.png"],
  },
};
