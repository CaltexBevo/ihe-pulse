      ...
      <section className="py-12">
        <div className="max-w-[var(--max-w)] mx-auto px-[var(--px)]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link
              href="/podcast"
              className="group bg-[var(--bg-card)] border border-[var(--border)] rounded-[14px] p-6 text-center transition-all duration-300 hover:border-[var(--border-hover)] hover:-translate-y-[2px] hover:shadow-[0_8px_28px_rgba(0,0,0,0.3)] block"
            >
              <svg className="w-7 h-7 mx-auto mb-3 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
              </svg>
              <h3 className="font-sans text-[1rem] font-bold mb-1">Podcast</h3>
            ...
            >
              ...
              <h3 className="font-sans text-[1rem] font-bold mb-1">AI Directory</h3>
              <p className="text-[0.78rem] text-[var(--text-secondary)] leading-[1.5] mb-3">
            ...
            >
              ...
              <h3 className="font-sans text-[1rem] font-bold mb-1">Top Prompts</h3>
              <p className="text-[0.78rem] text-[var(--text-secondary)] leading-[1.5] mb-3">
            ...
            >
              ...
              <h3 className="font-sans text-[1rem] font-bold mb-1">Educator Tools</h3>
              <p className="text-[0.78rem] text-[var(--text-secondary)] leading-[1.5] mb-3">
